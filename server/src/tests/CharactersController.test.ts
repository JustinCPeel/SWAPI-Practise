...
//       await charactersController.fetchListCharacters(
//         req as Request,
//         res as Response
//       );

//       expect(mockCharacterService.fetchAllCharacters).toHaveBeenCalledTimes(1);
...
//       mockCharacterService.fetchAllCharacters.mockRejectedValue(mockError);
